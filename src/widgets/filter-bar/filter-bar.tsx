import { onSetIsFilterMenuOpen } from "@shared/components/drawer/filter-menu";
import { FilterIcon } from "./filter-icon";

export default function FilterBar() {
  return (
    <div className="sticky top-0 h-14 md:h-16 z-10 flex xl:hidden items-center justify-between py-3 px-5 lg:px-7 bg-light border-t border-b border-border-200">
      <button
        onClick={() => onSetIsFilterMenuOpen(true)}
